...
class Solution:
    def tic_tac_toe(self,a,b):
        ...
        key = [[0,3,2,7,9,0,4,0,5],[3,0,1,0,8,0,0,5,0],[2,1,0,0,7,9,5,0,6]，[7,0,0,0,6,5,1,0,0]，[9,8,7,6,0,4,3,2,1]，[0,0,9,5,4,0,0,0,3]，[4,0,5,1,3,0,0,9,8]，[0,5,0,0,2,0,9,0,7]，[5,0,6,0,1,3,8,7,0]]
